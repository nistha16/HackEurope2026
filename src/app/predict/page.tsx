    ...
    <main className="min-h-screen bg-zinc-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 sm:py-14 space-y-8">
        ...
        <div className="text-center space-y-2">
          <Link href="/" className="inline-flex items-center gap-1.5 text-sm text-zinc-400 hover:text-zinc-600 transition-colors">
            ← Back to home
          </Link>
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            Logistic Regression + XGBoost blended with a 60-day rate percentile and 6 technical indicators.
          </p>
        </div>
