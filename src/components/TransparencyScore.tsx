...
> = {
  A: {
    bg: "bg-green-100",
    text: "text-green-800",
    description: "Excellent — uses mid-market rate with near-zero markup.",
  },
  B: {
    bg: "bg-blue-100",
    text: "text-blue-800",
    description: "Good — small FX markup under 1.5%.",
  },
  C: {
    bg: "bg-yellow-100",
    text: "text-yellow-800",
    description: "Fair — moderate FX markup between 1.5% and 3%.",
  },
  D: {
    bg: "bg-orange-100",
    text: "text-orange-800",
    description: "Poor — high FX markup between 3% and 5%.",
  },
  F: {
    bg: "bg-red-100",
    text: "text-red-800",
    description: "Failing — significant hidden costs, markup over 5%.",
  },
};
...
export function TransparencyScore({ score, className }: Props) {
  ...
  return (
    <div className="relative inline-block group">
      <span
        className={cn(
          "inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold cursor-default",
          config.bg,
          config.text,
          className
        )}
