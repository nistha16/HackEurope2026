...
**Premium Subscription (€2.99/mo via Stripe Billing):** Unlimited comparisons, rate alerts, 30-day predictions.
...
- **Person 2 (P2):** Backend Lead (Next.js APIs, Supabase, Stripe, Engine)
...
**2:00-2:20 - Voice Assistant:**
Ask: "Send 500 euros to Morocco." ElevenLabs reads back the best option and ML timing advice. **Play ElevenLabs Audio**.
